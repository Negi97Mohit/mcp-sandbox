...
contextBridge.exposeInMainWorld("api", {
    ...
    aiExplainTool: (toolName: string, isCustom: boolean) => ipcRenderer.invoke("custom-tools:ai-explain", toolName, isCustom),
    readToolSource: (toolName: string, isCustom: boolean) => ipcRenderer.invoke("custom-tools:read-source", toolName, isCustom),
    aiGenerateCustomTool: (details: any) => ipcRenderer.invoke("custom-tools:ai-generate-custom", details),
    aiModifyBuiltinTool: (toolName: string, prompt: string) => ipcRenderer.invoke("custom-tools:ai-modify-builtin", toolName, prompt),
    getGitDiff: (filePath: string) => ipcRenderer.invoke("custom-tools:git-diff", filePath),
    discardGitChanges: (filePath: string) => ipcRenderer.invoke("custom-tools:git-discard", filePath),
    onAiModifyLog: (cb: (text: string) => void) => {
        ipcRenderer.on("custom-tools:ai-modify-log", (_e, text) => cb(text));
    },
    offAiModifyLog: () => {
        ipcRenderer.removeAllListeners("custom-tools:ai-modify-log");
    },
