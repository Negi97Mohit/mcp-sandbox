...
if (!CONFIG.NETLIFY_TOKEN)
    console.warn("⚠️  NETLIFY_TOKEN is missing (Netlify features disabled)");
if (!CONFIG.GITHUB_TOKEN)
    console.warn("⚠️  GITHUB_TOKEN is missing (GitHub tools disabled)");
if (!CONFIG.LANGFUSE_SECRET_KEY)
    console.log("📊  LANGFUSE keys not set — tracing in LOCAL mode only");
