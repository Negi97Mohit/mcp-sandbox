...
import type { AgentInput, AgentResult, TestResult } from "./agentTypes.js";

export class VerifierAgent extends BaseAgent {
  readonly name = "VerifierAgent";
  readonly agentType = "verify" as const;
  ...
  protected buildSystemPrompt(input: AgentInput): string {
    ...
    const modifiedFiles = (subTask.context?.modifiedFiles as string[]) ?? [];
