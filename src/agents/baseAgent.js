...
export class BaseAgent {
    ...
    async run(input) {
        ...
        try {
            ...
            return this.buildResult(input, false, "", toolCallsMade, latencyMs, totalTokenUsage, error.message);
        }
    }
    buildResult(input, success, output, toolCallsMade, latencyMs, tokenUsage, error) {
        const result = {
            taskId: input.taskId,
